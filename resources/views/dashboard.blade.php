...
<html lang="en">
    ...
    <body class="bg-gray-100">
        ...
        <main>
            <div id="home" class="grid grid-cols-1 md:grid-cols-2 gap-4 py-[70px] bg-gray-400 ">
                <!-- Left Column (Text) -->
            ...
            <div id="aboutus" class="grid grid-cols-1 md:grid-cols-2 gap-4 py-[70px] bg-white">
                <!-- Left Column (Text) -->
                <div class="flex justify-center items-center">
