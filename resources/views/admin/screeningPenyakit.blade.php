...
@section('main')
    <main>
        <div class="bg-white flex flex-col items-center justify-center min-h-screen p-4">
            ...
            <form action="{{ route('admin.screeningPenyakit.store') }} method="POST" enctype="multipart/form-data"
                ...
                <div class="flex items-center border-2 border-gray-300 rounded-lg px-4 py-2 w-full">
                    ...
                    <input id="leaf_image" type="file" name="leaf_image" class="hidden" onchange="updateFileName()"
                        required>
