    ...
    <main>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-[70px] bg-gray-200 px-4 md:px-12">
            ...
            <div class="flex flex-col pt-12">
                <h1 class="text-3xl md:text-4xl font-bold"><span class="text-green-600">Rasakan Nuansa Alam Berlibur</span><br>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-[70px] bg-white px-4 md:px-12">
            ...
            <!-- Right Column (Text) -->
            <div class="flex flex-col pt-12">
                <h1 class="text-3xl md:text-4xl font-bold"><span class="text-green-600">Suasana Seru di Kebun <br> Durian Kami</span></h1>
                <p class="mt-4 text-sm md:text-base">Nikmati pengalaman tak terlupakan bersama keluarga dan teman di tengah rindangnya kebun durian!
        ...
        <div class="bg-green-600 py-12 px-4 md:px-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                    ...
                    <p class="text-gray-600 text-sm md:text-base">Nikmati pengalaman menjelajahi kebun durian dan mencicipi durian segar
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                    ...
                    <p class="text-gray-600 text-sm md:text-base">Gunakan teknologi kami untuk memeriksa kesehatan durian dan memastikan
                        kualitasnya.</p>
                </div>
                <!-- Card 3 -->
                <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                    ...
                    <p class="text-gray-600 text-sm md:text-base">Deteksi jenis durian hanya dengan melihat ciri fisiknya dan temukan
        ...
        <div class="py-20 flex flex-col items-center text-center px-4">
            <div>
                ...
                <h3 class="text-sm md:text-base">Seputar <span class="text-green-600">Kampung Wisata Durian</span></h3>
            </div>
            <div>
